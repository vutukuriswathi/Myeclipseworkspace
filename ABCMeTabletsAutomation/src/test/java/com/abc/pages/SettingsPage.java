...
public class SettingsPage {
	...
	@AndroidFindBy(accessibility = "PARENT SETTINGS")
	...
	// About ABC ME menu item
	@iOSFindBy(xpath = "//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[3]")
	public MobileElement iosAboutAbcMe;

	// Information for parents menu item
	@iOSFindBy(xpath = "//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[4]")
	public MobileElement iosInformationForParents;

	// faqs menu item
	@iOSFindBy(xpath = "//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[5]")
	public MobileElement iosFaqs;

	// privacy and terms of use menu item
	@iOSFindBy(xpath = "//UIAApplication[1]/UIAWindow[1]/UIAPopover[1]/UIATableView[1]/UIATableCell[6]")
