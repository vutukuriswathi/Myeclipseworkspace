...
public class ErrorUtil {
	...
	/**
	 * @Method: addVerificationFailure
	 * @param:Throwable
	 * @Description:This method will add the verification failures.
	...
	/**
	 * @Method: getVerificationFailures
	 * @param:
	 * @Description:This method will get the verification failures
	 * @author :swathi Gunuputi
	 */
