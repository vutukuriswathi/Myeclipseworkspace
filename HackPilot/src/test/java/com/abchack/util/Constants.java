...
public class Constants {
	...
	// facebook icon cssselector class name
	public static final String facebookRedirectUrl = "https://www.facebook.com/triplejHack";

	// twitter icon cssselector class name
	public static final String twitterRedirectUrl = "https://twitter.com/triplejHack";

	// instagram icon cssselector class name
	public static final String InstagramRedirectUrl = "https://instagram.com/triplejhack/";

	// youtube icon cssselector class name
	public static final String youTubeRedirectUrl = "https://www.youtube.com/channel/UCd2KNtfphz8HvYzM4pwtHmg";

	// soundcloud icon cssselector class name
	public static final String soundCloudRedirectUrl = "https://soundcloud.com/triple-j-hack";
