...
public class CategoryPage {
	...
	@AndroidFindBy(xpath = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.support.v4.widget.DrawerLayout[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[2]/android.widget.FrameLayout[1]/android.widget.ListView[1]/android.widget.TextView[1]")
	...
	@AndroidFindBy(id = "au.net.abc.iview:id/watchlist")
	public MobileElement andYourIviewWatchListTxt;

	// recently viewed header text
	@AndroidFindBy(id = "au.net.abc.iview:id/recently_viewed")
	...
	@AndroidFindBy(id = "au.net.abc.iview:id/pin_text_fields_layout")
	...
	@AndroidFindBy(id = "au.net.abc.iview:id/close_btn")
	...
	public boolean verifyParentalFilter() {
		...
		if (TestBase.platform.equalsIgnoreCase("android")) {
			...
			if (andParentalFieldPwd.isDisplayed() && andParentalPinDesc.isDisplayed()
					&& andYourIviewParentalFilterTxt.isDisplayed())
				return true;
			else
				return false;
